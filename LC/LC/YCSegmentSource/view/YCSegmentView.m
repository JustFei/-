...
- (instancetype)initWithFrame:(CGRect)frame titleHeight:(CGFloat)height viewControllers:(NSArray<UIViewController *> *)viewControllers underColor:(UIColor *)backgroundColor {
...
- (void)setupAllViews {
    ...
    self.titleView = [[YCSegmentItemsContentView alloc] initWithFrame:CGRectZero titles:titles underColor:_backgroundColor];
